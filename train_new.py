...
def train(model, criterion, dataset,
    ...
    if args.model == 'bert':
        ...
        scheduler = WarmupLinearSchedule(
            ...
            t_total=t_total)
        raise NotImplementedError("Scheduler is not correctly implemented...")
    else:
        ...
        assert args.lr_steps is not None or args.lr_scheduler in ["cosine", "none"]
        if args.lr_steps is not None:
            args.lr_steps = args.lr_steps.split("-")
            args.lr_steps = [int(x) for x in args.lr_steps]
