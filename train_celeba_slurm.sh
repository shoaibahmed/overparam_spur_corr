    ...
    for width in 1 2 4 6 8 16 32 48 64 80 88 96; do
        ...
        srun -p batch -K -N1 --ntasks-per-node=1 --gpus-per-task=1 --cpus-per-gpu=4 --mem=24G \
                    ...
                    /opt/conda/bin/python /netscratch/siddiqui/Repositories/overparam_spur_corr/run_expt_supcon.py -s confounder -d CelebA -t Blond_Hair -c Male --fraction 1.0 --lr 0.01 \
                        ...
                        --log_dir /netscratch/siddiqui/Repositories/overparam_spur_corr/output_final/celebA_reweight_width_${width}_seed_${seed}_ce/ > /netscratch/siddiqui/Repositories/overparam_spur_corr/output_final/celebA_reweight_width_${width}_seed_${seed}_ce.log 2>&1 &
        ...
        srun -p batch -K -N1 --ntasks-per-node=1 --gpus-per-task=1 --cpus-per-gpu=4 --mem=24G \
                    ...
                    /opt/conda/bin/python /netscratch/siddiqui/Repositories/overparam_spur_corr/run_expt_supcon.py -s confounder -d CelebA -t Blond_Hair -c Male --fraction 1.0 --lr 0.01 \
                        ...
                        --log_dir /netscratch/siddiqui/Repositories/overparam_spur_corr/output_final/celebA_reweight_width_${width}_seed_${seed}_supcon/ > /netscratch/siddiqui/Repositories/overparam_spur_corr/output_final/celebA_reweight_width_${width}_seed_${seed}_ce.log 2>&1 &
    done
done
